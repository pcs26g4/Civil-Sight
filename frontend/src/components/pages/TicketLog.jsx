    ...
    <div className="ticket-log">
      ...
      <div className="table-wrapper" style={{
        ...
        <table className="ticket-table" style={{
          minWidth: "1300px", // Increased minimum width to accommodate new column
          width: "100%",
          tableLayout: "fixed"
        }}>
        <thead>
          ...
          <tbody>
            {loading ? (
              ...
              <tr>
                <td colSpan={currentUser?.role === "ADMIN" ? "13" : "12"} className="no-data">
                  No records found
                </td>
              </tr>
            ) : (
              paginatedTickets.map((ticket, index) => {
                ...
                return (
                  <tr key={ticket.sub_id || index}>
                    ...
                    {/* NEW COLUMN FOR INTERNAL MAP NAVIGATION */}
                    <td>
                      {lat && lng ? (
                        <button
